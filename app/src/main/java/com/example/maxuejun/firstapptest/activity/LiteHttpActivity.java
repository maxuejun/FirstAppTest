...
import com.example.maxuejun.firstapptest.MyHttpExceptHandler;
import com.example.maxuejun.firstapptest.R;
import com.example.maxuejun.firstapptest.model.CustomJSONParser;
import com.example.maxuejun.firstapptest.model.RichParam;
import com.example.maxuejun.firstapptest.model.User;
import com.example.maxuejun.firstapptest.model.UserParam;
...
public class LiteHttpActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_litehttp);
        activity = this;
        initViews();
        initLiteHttp();
    }
    ...
    private void initLiteHttp(){
        if(liteHttp == null){
            liteHttp = LiteHttp.build(this)
                    ...
                    .setJsonConvertor(new GsonImpl())       //json covertor
            ...
            liteHttp.getConfig()                // connect timeout: 5s
